  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <h1 class="text-white">PROVINSI JAWA TENGAH</h1>
        <p class="text-white">
          Sistem informasi ini merupakan aplikasi pemetaan geografis tempat wisata di wilayah Provinsi Jawa Tengah. Aplikasi ini memuat informasi dan lokasi dari tempat wisata yang ada di Provinsi Jawa Tengah.
        </p>
        ...
        <div class="row align-items-center">
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 7.5,
                center: new google.maps.LatLng(-7.0073392, 110.0994222),
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Aplikasi pemetaan geografis Wisata di Provinsi Jawa Tengah ini memuat informasi dan lokasi dari Wisata ALam dan WIsata Kuliner di Jawa Tengah. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing-masing tempat wisata. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
          </div>
        </div>
      </div>
